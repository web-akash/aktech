...
const BlogCategories = () => {
  ...
  const gettheme = async () => {
    try {
      ...
      const filter = res.data.filter((product) => product.category === "blog");
      console.log(filter);
      setProducts(filter);
      setVisibleProducts(filter.slice(0, productsPerPage).reverse());
    } catch (e) {
        ...
        {visibleProducts.map((product, index) => (
          ...
          >
            ...
            <div className="py-2 px-2 ">
              ...
              <div className="mt-5">
                <del className="font-light flex px-[2px]  text-[10px] text-black">
